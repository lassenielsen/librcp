...
deb: $(libname)$(libversion)
	...
	echo "Depends: "                                              >> debs/lib$(name)_$(version)_i386/DEBIAN/control
	echo "Recommends: "                                           >> debs/lib$(name)_$(version)_i386/DEBIAN/control
	echo "Suggests: libdpl"                                       >> debs/lib$(name)_$(version)_i386/DEBIAN/control
	echo "Conflicts: "                                            >> debs/lib$(name)_$(version)_i386/DEBIAN/control
	echo "Replaces: "                                             >> debs/lib$(name)_$(version)_i386/DEBIAN/control
	echo "Provides: librcp"                                       >> debs/lib$(name)_$(version)_i386/DEBIAN/control
